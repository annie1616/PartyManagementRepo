...
//                	RegistrationBean register=dao.getUserIdAndPassword(login.getUserId(), login.getUserPassword());
//                	if(register.getUserId().equals(login.getUserId()) && register.getPassword().equals(login.getUserPassword()))
//                	{
//                		if(register.getUserId().equals("Admin") && register.getPassword().equals("Admin"))
//                			return "Admin";
//                		else
//                			return "successlogin";
//                	}
