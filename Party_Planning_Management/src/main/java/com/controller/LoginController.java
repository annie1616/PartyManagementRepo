...
public class LoginController {
                ...
                public ModelAndView signIn(@Valid @ModelAttribute("login")Login login,BindingResult br,HttpSession session) {
                                ...
                                if(br.hasErrors()) {
                                                ...
                                                mv=new ModelAndView("adminhome");//admin page
                                                }
                                
                                                
                                                RegistrationBean register=dao.getUserIdAndPassword(login.getUserName(), login.getUserPassword());

                                                if( register!= null)
                                                {
                                                mv=new ModelAndView("successlogin");//user
